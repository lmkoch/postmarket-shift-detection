...
# from core.model import CamelyonDensenet, MNISTNet
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_mnist", action="store", type=str, help="MNIST data root", default="./data"
    )
    parser.add_argument(
        "--data_camelyon", action="store", type=str, help="Camelyon17 data root", default="./data"
    )
    parser.add_argument(
        "--model_mnist",
        action="store",
        type=str,
        help="MNIST task classifier path",
    ...
    parser.add_argument(
        ...
        action="store",
        type=str,
        help="MNIST task (no digit 5) classifier path",
    ...
    parser.add_argument(
        ...
        action="store",
        type=str,
        help="Camelyon17 task classifier path",
